    ...
    <div className="App">
      <header className="App-header">
        ...
        <table>
          <tbody>
            <tr>
              <td> <label htmlFor="greenInput">Green Letters:</label> </td>
            ...
            <tr>
              <td> <label htmlFor="YellowInput">Yellow Letters:</label></td>
            ...
            <tr>
              <td> <label htmlFor="GreyInput">Grey Letters:</label></td>
